...
describe('FacebookApi', () => {
  ...
  // should get app token
  it('deve obter o token do aplicativo', async () => {
  ...
  // should get debug token
  it('deve obter token de depuração', async () => {
    await sut.loadUser({ token: 'any_client_token' })
  ...
  it('deve obter as informações do usuário', async () => {
    await sut.loadUser({ token: 'any_client_token' })
  ...
  // should return facebook user info
  it('deve retornar as informações do facebook para o usuário', async () => {
